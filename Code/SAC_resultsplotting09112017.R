...
# GLM and GLM autocov and GLM.spev
...
mod.frames<- c("gams")
data.sets<- c("a", "b", "c", "d", "e", "f", "g", "h", "i", "j")
mod.formulas<- c("zero.one ~ x1 + x2 + x.random + s(x,y)", "zero.one ~ x1 + x.random + s(x,y)", "zero.one ~ x2 + x.random + s(x,y)", "zero.one ~ x1 + x2 + s(x,y)", "zero.one ~ s(x,y)", "zero.one ~ x1 + s(x,y)", "zero.one ~ x2 + s(x,y)", "zero.one ~ x.random + s(x,y)")
batch<- c("emm.ewf.bf", "emm.ewm.bm", "emm.ewc.bs", "emm.emf.bf", "emm.emm.bm", "emm.emc.bs", "emm.esf.bf", "emm.esm.bm", "emm.esc.bs")
gam<- expand.grid(mod.frames, data.sets, mod.formulas, batch)
names(gam)<- c("model.fit", "dataset.group", "model.formula", "batch")

# Custom
mod.frames<- c("negexp.fix", "negexp.free")
data.sets<- c("a", "b", "c", "d", "e", "f", "g", "h", "i", "j")
mod.formulas<- c("zero.one ~ x1 + x2 + x.random", "zero.one ~ x1 + x.random", "zero.one ~ x2 + x.random", "zero.one ~ x1 + x2", "zero.one ~ x2", "zero.one ~ x1", "zero.one ~ x.random", "zero.one ~ 1")
batch<- c("emm.ewf.bf", "emm.ewm.bm", "emm.ewc.bs", "emm.emf.bf", "emm.emm.bm", "emm.emc.bs", "emm.esf.bf", "emm.esm.bm", "emm.esc.bs")
                                         ...
                                         ifelse(all.mods$model.fit == "glm.autocov" & all.mods$model.formula == "zero.one ~ x1 + x.random", "autocov.nox2",
                                                ifelse(all.mods$model.fit == "glm.spev" & all.mods$model.formula == "zero.one ~ x1 + x2 + x.random", "spev.negexp",
                                                       ifelse(all.mods$model.fit == "glm.spev" & all.mods$model.formula == "zero.one ~ x1 + x.random", "spev.negexp.nox2", 
                                                              ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x1 + x2 + x.random", "mle2.negexp.fix",
                                                                     ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x1 + x.random", "mle2.negexp.fix.nox2",
                                                                            ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x2 + x.random", "mle2.negexp.fix.nox1",
                                                                                   ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x1 + x2", "mle2.negexp.fix.x1x2",
                                                                                          ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x1", "mle2.negexp.fix.x1xnbi",
                                                                                                 ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x2", "mle2.negexp.fix.x2xnbi",
                                                                                                        ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ x.random", "mle2.negexp.fix.xrandxnbi",
                                                                                                               ifelse(all.mods$model.fit == "negexp.fix" & all.mods$model.formula == "zero.one ~ 1", "mle2.negexp.fix.xnbi", 
                                                                                                                                                  ...
                                                                                                                                                  ifelse(all.mods$model.fit == "negexp.free" & all.mods$model.formula == "zero.one ~ x1", "mle2.negexp.free.x1xnbi",
                                                                                                                                                         ifelse(all.mods$model.fit == "negexp.free" & all.mods$model.formula == "zero.one ~ x2", "mle2.negexp.free.x2xnbi",
                                                                                                                                                                ifelse(all.mods$model.fit == "negexp.free" & all.mods$model.formula == "zero.one ~ x.random", "mle2.negexp.free.xrandxnbi",
                                                                                                                                                                       ifelse(all.mods$model.fit == "negexp.free" & all.mods$model.formula == "zero.one ~ 1", "mle2.negexp.free.xnbi", NA))))))))))))))))))))))

all.mods$scenario<- ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x1 + x2 + x.random + s(x,y)", "gams",
                           ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x1 + x.random + s(x,y)", "gams.nox2",
                                  ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x2 + x.random + s(x,y)", "gams.x2xrand",
                                         ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x1 + x2 + s(x,y)", "gams.x1x2smooth",
                                                ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x1 + s(x,y)", "gams.x1smooth",
                                                       ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x2 + s(x,y)", "gams.x2smooth",
                                                              ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ x.random + s(x,y)", "gams.xrandsmooth",
                                                                     ifelse(all.mods$model.fit == "gams" & all.mods$model.formula == "zero.one ~ s(x,y)", "gams.smooth", all.mods$scenario))))))))
...
all.mods$scenario<- ifelse(all.mods$model.fit == "spglm" & all.mods$model.formula == "zero.one ~ x1 + x2 + x.random", "spglm",
                           ifelse(all.mods$model.fit == "spglm" & all.mods$model.formula == "zero.one ~ x1 + x.random", "spglm.nox2",
                                  ifelse(all.mods$model.fit == "spglm" & all.mods$model.formula == "zero.one ~ x2 + x.random", "spglm.x2xrand",
                                         ifelse(all.mods$model.fit == "spglm" & all.mods$model.formula == "zero.one ~ x1 + x2", "spglm.x1x2",
...
write.csv(models.missing, "./Inputs/MissingmodelsFeb2018.csv")
