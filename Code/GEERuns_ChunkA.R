...
data.dir<- "~/Dropbox/rSACWinter2016/SimulatedData/"
...
source("~/Dropbox/rSACWinter2016/Code/SACfunctions_modelingandanalysis03062017_Anthill.R")

### Run GEE models
model.par<- read.csv("~/Dropbox/rSACWinter2016/Input/SAC_batchlist_models_03062017_gee.csv", as.is = TRUE)
model.par<- model.newruns.03302016
...
stem.dir<- "~/Dropbox/rSACWinter2016/FitsGEE/"
...
model.newruns.03302016<- model.par[models.missing.index$id,]
...
### Run GEE models
model.par<- model.newruns.1129pm2016
